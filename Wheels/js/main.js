...
function animateHeroBackground() {
    heroBg.style.backgroundImage = "url(imgs/bg-light.jpg)";

    setTimeout(() => {
        heroBg.style.backgroundImage = "url(imgs/bg.jpg)";
    }, 1000);
}

// Set the interval for the animation
setInterval(animateHeroBackground, 2200);
...
function theChecker() {
  ...
  slideNumberElement.textContent = carTypes[currentSlide-1];
...
window.onload = function() {
  // Get references to the input fields and the textarea
  ...
  var messageField = document.querySelector('.textarea textarea');
